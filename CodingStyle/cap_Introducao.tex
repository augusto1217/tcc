...
Se analisarmos o código de diferentes desenvolvedores, existe a possibilidade de existir diferenças dentre os estilos utilizados no momento de escrever e formatar um código-fonte em uma determinada linguagem. Por exemplo, ao declarar uma função ou método, um desenvolvedor pode utilizar chaves ('\{' e '\}') em linhas separadas ou abrir a chave na mesma linha da declaração \cite{teles2014}. As Tabelas \ref{table:diff2Program} ilustram dois código com diferentes estilos de codificação.
...
\begin{table}[h]
	...
	\textbf{\hspace{15.2 mm} Programador 1 \hspace{15.2 mm} }}  & 
	\multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}
	\textbf{\hspace{15.2 mm} Programador 2 \hspace{15.2 mm} }} \\ 
	\hline
	\multicolumn{5}{|l|}{
		\begin{tabular}[c]{@{}l@{}}
			\hspace{8 mm} if (i \textgreater= 0) \{\\ 
			\hspace{16 mm} faça alguma coisa 
			\hspace{13 mm} \\ 
			\hspace{8 mm} \}
		\end{tabular}} & 
...
No Capítulo 2 temos a fundamentação teórica do trabalho, com o histórico estilos de codificação. No Capítulo 3 é apresentada a metodologia, apresentando as ferramentas e tecnologias utilizadas neste trabalho. No Cap 4 são apresentado¿ e por aí vai, até a Conclusão.
