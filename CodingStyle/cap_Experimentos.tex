...
A versão utilizada neste trabalho é a 2.7.9, release 10-12-2014, esta versão faz parte da instalação padrão do sistema operacional citado na seção \ref{linux_mint}, caso deseje executar uma instalação de outra versão superior a utilizada neste estudo, é necessário acessar o visitar o sítio oficial da linguagem, na aba de downloads\footnote{https://www.python.org/downloads/}.
...
\lstinputlisting[language=Python, caption=Procedimento responsável pela execução do procedimento execExtractFiles.py., label=extractFile2]{cods/extractFiles2.py}
