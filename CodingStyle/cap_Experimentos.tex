...
Uma ferramenta que formata automaticamente o código Python em conformidade com o guia de estilo PEP 8. O utilitário pep8 é utilizado para determinar quais partes do código precisa ser formatado. A ferramenta é capaz de corrigir a maioria dos problemas de formatação que podem ser relatados por pep8.
...
Na Tabela \ref{fixautoPep8}, é exibido os códigos de erros que esta ferramenta é capaz de corrigir, seguindo o estilo descrito na seção \ref{pep8}. Para mais informações sobre a 
...
\begin{table}[!ht]
        ...
        \centering
        \begin{footnotesize}
        \begin{tabularx}{0.89\textwidth}{>{\ttfamily}lX}
        \toprule
	...
	\rowcolor[gray]{0.8}
		E20  & Remover espaços em branco estranhos. \\
		E211 & Remover espaços em branco estranhos. \\
	\rowcolor[gray]{0.8}
		E22  & Corrige espaços em branco estranhos ao redor de palavras chaves. \\
	...
	\rowcolor[gray]{0.8}
		...
		E27  & Corrige espaços em branco estranho ao redor de palavras chaves. \\
	\rowcolor[gray]{0.8}
	...
	\rowcolor[gray]{0.8}
		...
		E70  & Coloque instrução composta separados por ponto e vírgula em linhas separadas. \\
	\rowcolor[gray]{0.8}
