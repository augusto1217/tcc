...
\begin{table}[ht!]
        \caption{Ocorrências do erro E501}
        \label{ee501}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E231}
        \label{ee231}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E128}
        \label{ee128}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E265}
        \label{ee265}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E302}
        \label{ee302}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E251}
        \label{ee251}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E122}
        \label{ee122}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E201}
        \label{ee201}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E203}
        \label{ee203}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E225}
        \label{ee225}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
...
\begin{table}[ht!]
        \caption{Ocorrências do erro E202}
        \label{ee202}
        \centering
        \begin{tabularx}{0.9\textwidth}{>{\ttfamily}X}
        \midrule
